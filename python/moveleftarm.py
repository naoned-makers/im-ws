...
# TODO   pwm.setPWM(CHANNEL_LEFT_ARM, 0, SERVO_MIN_LEFT_ARM)
  print "Bras gauche à complétement baissé"
  time.sleep(sleep)
# TODO   pwm.setPWM(CHANNEL_LEFT_ARM, 0, SERVO_MIDDLE_LEFT_ARM)
  print "Bras gauche à complétement levé"
  time.sleep(sleep)
# TODO   pwm.setPWM(CHANNEL_LEFT_ARM, 0, SERVO_MAX_LEFT_ARM)
  print "Bras gauche à complétement baissé"
  time.sleep(sleep)
# TODO   pwm.setPWM(CHANNEL_LEFT_ARM, 0, SERVO_MIN_LEFT_ARM)
  time.sleep(sleep)
